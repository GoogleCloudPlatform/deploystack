...
require (
	github.com/GoogleCloudPlatform/deploystack/config v1.9.0
	github.com/GoogleCloudPlatform/deploystack/gcloud v1.8.1
	github.com/GoogleCloudPlatform/deploystack/github v1.8.0
	github.com/GoogleCloudPlatform/deploystack/terraform v1.9.0
...
require (
	...
	github.com/hashicorp/terraform-config-inspect v0.0.0-20230223165911-2d94e3d51111 // indirect
